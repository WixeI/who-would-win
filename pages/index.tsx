  ...
  return (
    <motion.div
      ...
      <img
        ...
        alt="bg"
        className="absolute left-0 top-0 -z-10 h-full w-full opacity-[7%]"
      />
      <div className="absolute left-0 top-0 -z-10 h-full w-full bg-[url('../assets/stone.jpg')] opacity-60 mix-blend-color-dodge brightness-[.2]" />
      <div className="absolute left-0 top-0 -z-10 h-full w-full bg-gradient-to-b from-slate-500 to-slate-900 opacity-40 mix-blend-overlay"></div>
      <Head>
      ...
      <div className="flex h-full w-full">
        <aside className="relative flex flex-col gap-2 p-4">
          {' '}
          {/* Change Page */}
          <Link href="/Ranking">
            <a className="relative py-3 px-6">
              Ranking
              <img
          ...
          <img
            ...
            alt="sidebar"
            className="absolute left-0 top-0 -z-10 h-full w-full scale-y-125 drop-shadow-[0_0_1rem_rgba(0,0,0,0.5)]"
          />
        </aside>
